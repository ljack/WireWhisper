...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        private val MIGRATION_4_5 = object : Migration(4, 5) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE flows ADD COLUMN blocked INTEGER NOT NULL DEFAULT 0")
                db.execSQL("ALTER TABLE flows ADD COLUMN blockReason TEXT DEFAULT NULL")
                db.execSQL("CREATE INDEX IF NOT EXISTS index_flows_blocked ON flows (blocked)")
            }
        }
